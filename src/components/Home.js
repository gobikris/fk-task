          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex gap-4">
              ...
              <li class="nav-item dropdown ">
                <a
                  class="nav-link dropdown-toggle active text-light fw-bold"
                  href="#"
                  role="button"
                ...
                <ul class="dropdown-menu ">
                  ...
                  <li>
                    <Link class="dropdown-item" to="#">
                      <i
                        className="fa fa-gift text-primary"
                        aria-hidden="true"
                      ></i>{" "}
                      Gift Cards
                    </Link>
              ...
              <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu ">
                  ...
                  <li>
                    <Link class="dropdown-item" to="#">
                      <i
                        className="fa fa fa-download text-primary"
                        aria-hidden="true"
                      ></i>{" "}
                      Download App
                    </Link>
              ...
              <li class="nav-item">
                <a class="nav-link active fw-bold text-light">
